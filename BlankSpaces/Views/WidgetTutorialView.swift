...
struct WidgetTutorialView: View {
    ...
    private let steps: [Step] = [
        ...
        .init(id: 3, symbol: "plus.square.on.square",
              title: "Add top and bottom widgets",
              body: "Add the medium Top widget and the large Bottom widget to your Home Screen by tapping the add button at the bottom."),
